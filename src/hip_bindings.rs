...
pub const __HIP_PLATFORM_AMD__: u32 = 1;
...
pub const HIP_VERSION_GITHASH: &[u8; 10] = b"1b9c17779\0";
...
pub type hipHostFn_t =
    ::std::option::Option<extern "C" fn(userData: *mut ::std::os::raw::c_void)>;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    ...
    pub fn hipMalloc(ptr: *const *mut ::std::os::raw::c_void, size: usize) -> hipError_t;
}
extern "C" {
